 ...
 * @date 2023-03-09
 */
public class NoteNote extends BaseEntity
{
    ...
    /** 子菜单 */
    private List<NoteNote> children = new ArrayList<NoteNote>();
    ...
    public List<NoteNote> getChildren() {
        return children;
    }

    public void setChildren(List<NoteNote> children) {
