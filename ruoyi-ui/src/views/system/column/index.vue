<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="columnList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="列id" align="center" prop="id" />
      <el-table-column label="列名称" align="center" prop="name" />
      <el-table-column label="列类型" align="center" prop="type" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="列名称" prop="name">
          <el-input v-model="form.name" placeholder="请输入列名称" />
        </el-form-item>
        <el-form-item label="排序" prop="sort">
