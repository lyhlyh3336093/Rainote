<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="添加好友时间" prop="creatTime">
    ...
    <el-table v-loading="loading" :data="friendList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="好友主键" align="center" prop="id" />
      <el-table-column label="用户id" align="center" prop="userId" />
      <el-table-column label="好友id" align="center" prop="friendId" />
      <el-table-column label="状态" align="center" prop="status" />
      <el-table-column label="添加好友时间" align="center" prop="creatTime" width="180">
...
<script>
import { listFriend, getFriend, delFriend, addFriend, updateFriend } from "@/api/system/friend";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除friend编号为"' + ids + '"的数据项？').then(function() {
