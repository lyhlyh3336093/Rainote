<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="域名" prop="link">
        <el-input
      ...
      <el-form-item label="应用所属公司" prop="company">
        <el-input
          v-model="queryParams.company"
          placeholder="请输入应用所属公司"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="appList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="域名" align="center" prop="link" />
      ...
      <el-table-column label="应用所属公司" align="center" prop="company" />
      <el-table-column label="logo图" align="center" prop="logo" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="域名" prop="link">
          <el-input v-model="form.link" placeholder="请输入域名" />
        </el-form-item>
        <el-form-item label="描述" prop="description">
        ...
        <el-form-item label="创建者" prop="creater">
          <el-input v-model="form.creater" placeholder="请输入创建者" />
        </el-form-item>
        <el-form-item label="应用所属公司" prop="company">
          <el-input v-model="form.company" placeholder="请输入应用所属公司" />
        </el-form-item>
        <el-form-item label="logo图" prop="logo">
          <el-input v-model="form.logo" placeholder="请输入logo图" />
        </el-form-item>
      </el-form>
